        ...
        <div id="about" class="row about-section">
            ...
            <div class="col-lg-4 about-card">
                ...
                <ul class="mt40 info list-unstyled">
                    <li><span>Birthdate</span> : 17/01/2003</li>
                    <li><span>Email</span> : hunglq1701@gmail.com</li>
                    <li><span>Phone</span> : + (84) 975944351</li>
                    <li><span>Skype</span> : Hung_Le </li>
                    <li><span>Address</span> :  TP Vinh_Nghệ An</li>
                </ul>
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10 ">
                                <h6 class="d-inline">Phone : <br> <span class="text-muted">+ (84) 975944351</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Address :<br> <span class="text-muted">Tp Vinh_Nghệ An.</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span class="text-muted">hunglq1701@gmail.com</span></h6>
                            </div>
                        </div>
